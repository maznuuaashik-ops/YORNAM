...
const STEPS = [
  { icon: Brain, text: 'Initializing AI Engine', detail: 'Loading neural engine v4...' },
  { icon: Video, text: 'Reading Instagram Reel', detail: 'Extracting frames and metadata...' },
  { icon: Fish, text: 'Detecting Hook', detail: 'Analyzing first-frame engagement signals...' },
  { icon: Music, text: 'Analyzing Audio', detail: 'Processing audio sync and waveform...' },
  { icon: MessageSquare, text: 'Reading Caption', detail: 'Parsing text and hashtag structure...' },
  { icon: Users, text: 'Detecting Target Audience', detail: 'Matching content to audience segments...' },
  { icon: TrendingUp, text: 'Predicting Retention', detail: 'Modeling viewer drop-off curves...' },
  { icon: Heart, text: 'Predicting Engagement', detail: 'Estimating likes, shares, and saves...' },
  { icon: Flame, text: 'Calculating Viral Score', detail: 'Computing composite virality index...' },
  { icon: Lightbulb, text: 'Generating AI Suggestions', detail: 'Building actionable recommendations...' },
  { icon: Sparkles, text: 'Building Final Report', detail: 'Compiling virality score and verdict...' },
]
      ...
      <div className="relative z-10 max-w-lg w-full">
        ...
        <div className="flex flex-col items-center mb-10">
          ...
          <motion.h3
            ...
            className="text-xl sm:text-2xl font-bold mt-6 mb-1"
          ...
          <motion.p
            ...
            style={{ color: 'var(--text-tertiary)' }}
          >
            Processing through {STEPS.length} intelligence layers
          </motion.p>
        </div>
        ...
        <div className="mt-8">
          <div className="flex justify-between text-xs mb-2" style={{ color: 'var(--text-quaternary)' }}>
            <span>{completedSteps.size}/{STEPS.length} layers complete</span>
